...
df <- v2.data
attach(df)
modelov2nomit <- lmer(Tiempo ~ Juntas + (1 + Juntas | Participante) + (1 + Juntas | Item))
...
df <- v2.data
attach(df)
modelov2nomRS <- lmer(Tiempo ~ Juntas + (1 + Juntas | Participante))
...
df <- v2.data
attach(df)
modelov2Anom <- lmer(Tiempo ~ TCDD + (1 + TCDD | Participante))
...
df <- v3.data
attach(df)
modelov3DDnomit <- lmer(Tiempo ~ TCDD * MD + (1 + TCDD | Participante) + (1 + MD | Participante) + (1 + TCDD | Item) + (1 + MD | Item))
...
df <- v3.data
attach(df)
modelov3DDnom <- lmer(Tiempo ~ TCDD * MD + (1 + TCDD | Participante) + (1 + MD | Participante))
...
df <- v4.data
attach(df)
modelov4nomit <- lmer(Tiempo ~ MD * TCDD + (1 + MD | Participante) + (1 + TCDD | Participante) + (1 + MD | Item) + (1 + TCDD | Item))
...
df <- v4.data
attach(df)
modelov4nom <- lmer(Tiempo ~ MD * TCDD + (1 + MD | Participante) + (1 + TCDD | Participante))
summary(modelov4nom)
anova(modelov4nom)
boxplot(Tiempo ~ MD * TCDD)
boxplot(Tiempo ~ Imagen)
...
df <- v4.data
attach(df)
modelov4it <- lmer(Tiempo ~ MD * TCDD + (1 + MD | Item) + (1 + TCDD | Item))
summary(modelov4it)
anova(modelov4it)
boxplot(Tiempo ~ MD * TCDD)
boxplot(Tiempo ~ TCDD)
...
df <- v5.data
attach(df)
modelov5nomit <- lmer(Tiempo ~  MD * TCDD + (1 + MD | Participante) + (1 + MD | Item) + (1 + TCDD | Participante) + (1 + TCDD | Item))
...
df <- v5.data
attach(df)
modelov5nom <- lmer(Tiempo ~  MD * TCDD + (1 + MD | Participante)  + (1 + TCDD | Participante))
summary(modelov5nom)
anova(modelov5nom)
boxplot(Tiempo ~ TCDD * MD)
...
df <- v6.data
attach(df)
modelov6nomit <- lmer(Tiempo ~  MD * TCDD + (1 + MD | Participante) + (1 + MD | Item) + (1 + TCDD | Participante) + (1 + TCDD | Item))
summary(modelov6nomit)
anova(modelov6nomit)
boxplot(Tiempo ~ TCDD * MD)
emmeans(modelov6nomit, pairwise ~ TCDD * MD)
AIC(modelov6nomit)
detach(df)
...
df <- v6.data
attach(df)
modelov6nom <- lmer(Tiempo ~  MD * TCDD + (1 + MD | Participante)  + (1 + TCDD | Participante))
summary(modelov6nom)
anova(modelov6nomit)
boxplot(Tiempo ~ TCDD * MD)
...
df <- v6.data
attach(df)
modelov6it <- lmer(Tiempo ~  MD * TCDD + (1 + MD | Item) + (1 + TCDD | Item))
summary(modelov6it)
anova(modelov6it)
boxplot(Tiempo ~ TCDD * MD)
emmeans(modelov6it, pairwise ~ TCDD * MD)
AIC(modelov6it)
detach(df)
